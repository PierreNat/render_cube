...
Version 3
implementation of variable leanring rate
name and variable at the beginning of the document
"""
import torch
import numpy as np
...
torch.save(model.state_dict(), './{}_model_train_{}_{}_batchs_{}_epochs_{}.pth'.format(date4File, cubeSetName, str(batch_size), str(n_epochs), fileExtension))
