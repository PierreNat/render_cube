...
def main():
    ...
    parser.add_argument('-o', '--filename_output', type=str, default=os.path.join(data_dir, 'rubik2_colored.gif'))
    ...
    # draw object
    loop = tqdm.tqdm(range(0, 90, 1)) #start view angle, stop angle, step between 2 views
